...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publication.author'
        db.add_column(u'blog1_publication', 'author',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['auth.User'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publication.author'
        db.delete_column(u'blog1_publication', 'author_id')
